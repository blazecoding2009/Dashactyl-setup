...
read -p "Enter the secret cookie password (Leave blank for a autogenerated one): " cookiepassword
if [[ ${#cookiepassword} -ne]]; then
      cookiepassword = $RANDOM | md5sum | head -c 10
fi
